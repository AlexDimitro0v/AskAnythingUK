...
class LoggedIn(TestCase):
    ...
    def test_logged_in_pages(self):
        ...
        pages_to_test = ['profile-page', 'settings-page', 'dashboard', 'archive', 'new-feedback-request-page',
                         'get-premium-page']
    ...
    def test_logout(self):
        ...
        self.assertRedirects(response, reverse('landing-page'), status_code=302, target_status_code=200, msg_prefix='',
                             fetch_redirect_response=True)
        ...
        for page in pages_to_test:
            response = self.client.get(reverse(page))
            self.assertRedirects(response, "/login/?next=" + reverse(page), status_code=302, target_status_code=200,
